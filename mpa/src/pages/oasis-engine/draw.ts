...
export function draw() {
  ...
  const webcanvas = new WebCanvas(canvas as HTMLCanvasElement);
  ...
  // 创建一个方向光组件
  let directLight = lightEntity.addComponent<any>(DirectLight);
  ...
  cube.material = new BlinnPhongMaterial(engine);
